import { IconGear, IconKebabLarge } from "@utils/icon";
import Popover from ".";

/**
 * @prop icon: "kebab" | "gear"; 해당 팝오버를 토글시키는 버튼의 모양을 지정합니다.
...
export default function EditDeletePopover({
  ...
  return (
    <Popover>
      <Popover.Toggle>{icon === "gear" ? <IconGear /> : <IconKebabLarge />}</Popover.Toggle>
